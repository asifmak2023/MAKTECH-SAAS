...
<span style="color: #ffffff; font-size: 18px; line-height: 1; font-weight: 700;">OK</span>
</td>
</tr>
</table>

<h1 class="fade-item" style="box-sizing: border-box; color: #111111; font-weight: 700; margin: 0 0 10px; text-align: center; font-size: 22px; letter-spacing: -0.02em; animation-delay: 0.1s;">Confirm your email</h1>
...
Please confirm this email address belongs to your {{ config('app.name') }} workspace to finish setting up your account.
</p>
