...
<body>
    <div class="header">
        <div class="header-left">
            <div class="brand">PRAL Digital Invoicing</div>
    ...
    <div class="footer">
        Generated for PRAL Digital Invoicing (FBR). QR encodes {{ $invoice->fbr_invoice_number ?: 'a temporary identifier until FBR issues the invoice number' }}.
    </div>
</body>
</html>
