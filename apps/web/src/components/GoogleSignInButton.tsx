...
export default function GoogleSignInButton({ onError, label = "Sign in with Google" }: Props) {
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-3 text-[10px] uppercase tracking-[0.16em] text-[#767676]">
