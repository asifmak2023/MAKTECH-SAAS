...
const card =
  "rounded-xl bg-white border border-black/[0.06] p-4 shadow-[0_1px_2px_rgba(0,0,0,0.03),0_12px_28px_-12px_rgba(0,0,0,0.14)]";

const inputCls =
  "w-full rounded-md border border-slate-200 bg-white px-3 py-2 text-sm text-slate-900 placeholder:text-slate-400 focus:border-win-500 focus:outline-none focus:ring-2 focus:ring-win-500/20";
        ...
        <div className="mt-4 space-y-3 border-t border-slate-100 pt-4">
          ...
          <div className="flex items-center gap-2 pt-1">
            <button
              onClick={saveConfig}
              disabled={saving}
              className="rounded-md bg-win-600 px-4 py-2 text-sm font-medium text-white disabled:opacity-50"
            >
